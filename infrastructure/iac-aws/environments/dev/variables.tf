...
variable "target_account_id" {
  description = "The ID of the target AWS account where resources will be deployed (Client-Tlinks-Dev)."
  type        = string
}
...
variable "project_name_prefix" {
  description = "Prefix for naming all resources (e.g., saas-mfe-tlinks-dev)."
  type        = string
}
