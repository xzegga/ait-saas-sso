...
-- ==============================================================================
-- This migration creates all database tables in their final structure
-- ==============================================================================
...
comment on column public.recycle_bin.entity_type is 'Tipo de entidad eliminada (e.g., products, plans, entitlements, product_plans, organizations, profiles, product_role_definitions)';
